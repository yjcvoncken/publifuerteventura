...
function openCookieSettings(){if(cookieBanner)cookieBanner.hidden=false}
...
document.querySelector('[data-cookie-accept]')?.addEventListener('click',()=>saveCookieChoice('accepted'));
